...
# 배경 만들기
background = pygame.image.load(os.path.join(image_path, "nobita room.png"))
...
# 캐릭터 만들기
character = pygame.image.load(os.path.join(image_path, "download-removebg-preview.png"))
...
ball_images = [
    pygame.image.load(os.path.join(image_path, "dorayaki.png")),
    pygame.image.load(os.path.join(image_path, "dorayaki.png")),
    pygame.image.load(os.path.join(image_path, "dorayaki.png")),
    pygame.image.load(os.path.join(image_path, "dorayaki.png "))]
